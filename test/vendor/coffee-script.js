          ...
          function() {
            ...
            ;(e.starts = function(e, t, n) {
              ...
              (e.ends = function(e, t, n) {
                var i
                return (
                  (i = t.length), t === e.substr(e.length - i - (n || 0), i)
                )
              }),
              ...
              (e.count = function(e, t) {
                var n, i
                if (((n = i = 0), !t.length)) return 1 / 0
                for (; (i = 1 + e.indexOf(t, i)); ) n++
                return n
              }),
              ...
              (e.flatten = i = function(e) {
                ...
                for (n = [], r = 0, s = e.length; s > r; r++)
                  (t = e[r]),
                    t instanceof Array ? (n = n.concat(i(t))) : n.push(t)
                return n
              }),
              (e.del = function(e, t) {
                var n
              ...
              (e.addLocationDataFn = function(e, n) {
                return function(i) {
                  return (
                    'object' == typeof i &&
                      i.updateLocationDataIfMissing &&
                      i.updateLocationDataIfMissing(t(e, n)),
                    i
                  )
                }
              }),
              ...
              (o = function() {
                ...
                return this.code && this.location
                  ? ((p = this.location),
                    ...
                    (u = o),
                    (i = a === h ? c + 1 : e.length),
                    (l = e.slice(0, u).replace(/[^\s]/g, ' ') + s('^', i - u)),
                    ...
                    (null != (d = this.colorful) ? d : n) &&
                      ...
                      (e = e.slice(0, u) + t(e.slice(u, i)) + e.slice(i)),
                      (l = t(l))),
                    '' +
                      r +
                      ':' +
                  ...
                  return (
                    ...
                    (e.prototype.detectEnd = function(e, t, n) {
                      ...
                      for (a = this.tokens, i = 0; (o = a[e]); ) {
                        ...
                        if (!o || 0 > i) return n.call(this, o, e - 1)
                        ;(c = o[0]),
                          v.call(s, c) >= 0
                            ? (i += 1)
                            : ((h = o[0]), v.call(r, h) >= 0 && (i -= 1)),
                          (e += 1)
                      }
                      return e - 1
                    }),
                    (e.prototype.removeLeadingNewlines = function() {
                      var e, t, n, i, r
                      for (
                        r = this.tokens, e = n = 0, i = r.length;
                        i > n && ((t = r[e][0]), 'TERMINATOR' === t);
                        e = ++n
                      );
                    ...
                    (e.prototype.matchTags = function() {
                      ...
                      for (
                        t = arguments[0],
                          i = arguments.length >= 2 ? w.call(arguments, 1) : [],
                          e = 0,
                          n = r = 0,
                          s = i.length;
                        s >= 0 ? s > r : r > s;
                        ...
                        for (; 'HERECOMMENT' === this.tag(t + n + e); ) e += 2
                        if (
                          null != i[n] &&
                    ...
                    (e.prototype.findTagsBackwards = function(e, t) {
                      ...
                      for (
                        ...
                        (n.length ||
                          ...
                          0 > v.call(t, a) &&
                            ((c = this.tag(e)),
                            0 > v.call(s, c) || this.tokens[e].generated) &&
                            ((h = this.tag(e)), 0 > v.call(u, h))));

                      )
                        (i = this.tag(e)),
                          v.call(r, i) >= 0 && n.push(this.tag(e)),
                          (o = this.tag(e)),
                          v.call(s, o) >= 0 && n.length && n.pop(),
                          (e -= 1)
                    ...
                    (e.prototype.addImplicitBracesAndParens = function() {
                      ...
                      return (
                        (e = []),
                        this.scanTokens(function(t, i, l) {
                          var p,
                            d,
                            m,
                            b,
                            ...
                            (I = function(n, r) {
                              ...
                              return (
                                ...
                                e.push([
                                  '{',
                                  s,
                                  { sameLine: !0, startsLine: r, ours: !0 }
                                ]),
                                l.splice(s, 0, f('{', f(new String('{')), t)),
                                null == n ? (i += 1) : void 0
                              )
                            }),
                            (d = function(n) {
                          ...
                          if (v.call(s, $) >= 0) return e.push([$, i]), m(1)
                          if (v.call(r, $) >= 0) {
                            for (; b(); ) g() ? p() : y() ? d() : e.pop()
                            e.pop()
                          }
                          if (
                            ((v.call(c, $) >= 0 && t.spaced && !t.stringEnd) ||
                              ('?' === $ && i > 0 && !l[i - 1].spaced)) &&
                            (v.call(o, T) >= 0 ||
                              (v.call(h, T) >= 0 &&
                                !(null != (O = l[i + 1]) ? O.spaced : void 0) &&
                                !(null != (j = l[i + 1]) ? j.newLine : void 0)))
                          )
                            return (
                              '?' === $ && ($ = t[0] = 'FUNC_EXIST'),
                              A(i + 1),
                          ...
                          if (
                            v.call(c, $) >= 0 &&
                            this.matchTags(i + 1, 'INDENT', null, ':') &&
                            !this.findTagsBackwards(i, [
                              'CLASS',
                              'EXTENDS',
                              'IF',
                              'CATCH',
                          ...
                          if (':' === $) {
                            for (
                              N = '@' === this.tag(i - 2) ? i - 2 : i - 1;
                              'HERECOMMENT' === this.tag(N - 2);

                            )
                              N -= 2
                            return (
                              (this.insideForDeclaration = 'FOR' === T),
                              (_ =
                                0 === N ||
                                ((M = this.tag(N - 1)), v.call(u, M) >= 0) ||
                                l[N - 1].newLine),
                              S() &&
                              ((B = S()),
                              (D = B[0]),
                          ...
                          if (
                            (y() && v.call(u, $) >= 0 && (S()[2].sameLine = !1),
                            (w = 'OUTDENT' === L || C.newLine),
                            v.call(a, $) >= 0 || (v.call(n, $) >= 0 && w))
                          )
                            for (; b(); )
                              if (
                                ((V = S()),
                          ...
                          if (
                            !(
                              ...
                              !y() ||
                              this.insideForDeclaration ||
                              ('TERMINATOR' === T && this.looksObjectish(i + 2))
                            )
                          )
                            for (F = 'OUTDENT' === T ? 1 : 0; y(); ) d(i + F)
                          return m(1)
                        })
                      )
                    }),
                    (e.prototype.addLocationDataToGeneratedTokens = function() {
                      return this.scanTokens(function(e, t, n) {
                        ...
                        return e[2]
                          ...
                          ? ('{' === e[0] &&
                            (s = null != (a = n[t + 1]) ? a[2] : void 0)
                              ? ((r = s.first_line), (i = s.first_column))
                              : (o = null != (c = n[t - 1]) ? c[2] : void 0)
                              ? ((r = o.last_line), (i = o.last_column))
                              : (r = i = 0),
                            (e[2] = {
                              first_line: r,
                              first_column: i,
                      ...
                      return (
                        ...
                        (t = function(e, t) {
                          ...
                          return (
                            (';' !== e[1] &&
                              ...
                              !(
                                'TERMINATOR' === e[0] &&
                                ((s = this.tag(t + 1)), v.call(i, s) >= 0)
                              ) &&
                              !('ELSE' === e[0] && 'THEN' !== o) &&
                              !!(
                                ('CATCH' !== (a = e[0]) && 'FINALLY' !== a) ||
                                ('->' !== o && '=>' !== o)
                              )) ||
                            ((c = e[0]),
                            v.call(n, c) >= 0 && this.tokens[t - 1].newLine)
                          )
                        }),
                        (e = function(e, t) {
                        ...
                        this.scanTokens(function(n, a, c) {
                          ...
                          if (((l = n[0]), 'TERMINATOR' === l)) {
                            if (
                              'ELSE' === this.tag(a + 1) &&
                              'OUTDENT' !== this.tag(a - 1)
                            )
                              return (
                                c.splice.apply(
                                  c,
                                  [a, 1].concat(w.call(this.indentation()))
                                ),
                                1
                              )
                          ...
                          return v.call(d, l) >= 0 &&
                            'INDENT' !== this.tag(a + 1) &&
                            ('ELSE' !== l || 'IF' !== this.tag(a + 1))
                            ? ((o = l),
                              (m = this.indentation(c[a])),
                              (r = m[0]),
                              (s = m[1]),
                              'THEN' === o && (r.fromThen = !0),
                              c.splice(a + 1, 0, r),
        ...
        return (
          function() {
            ...
            ;(et = require('./rewriter')),
              ...
              (J = tt.repeat),
              (X = tt.invertLiterate),
              (K = tt.locationDataToString),
              (Q = tt.throwSyntaxError),
              (e.Lexer = N = (function() {
                function e() {}
                return (
                      ...
                      ? ((c = h[0]),
                        ...
                        'own' === i && 'FOR' === this.tag()
                          ...
                          : ((n =
                            ...
                            (p = 'IDENTIFIER'),
                            !n &&
                              (nt.call(T, i) >= 0 || nt.call(a, i) >= 0) &&
                              ((p = i.toUpperCase()),
                              'WHEN' === p &&
                              ((m = this.tag()), nt.call(F, m) >= 0)
                                ? (p = 'LEADING_WHEN')
                                : 'FOR' === p
                                ? (this.seenFor = !0)
                                : 'UNLESS' === p
                                ...
                                ? (p = 'UNARY')
                                : nt.call($, p) >= 0 &&
                                  ('INSTANCEOF' !== p && this.seenFor
                                    ? ((p = 'FOR' + p), (this.seenFor = !1))
                                    : ((p = 'RELATION'),
                                      '!' === this.value() &&
                                        ((l = this.tokens.pop()),
                                        (i = '!' + i))))),
                            ...
                            (d = this.token(p, i, 0, r)),
                            l &&
                              ((g = [l[2].first_line, l[2].first_column]),
                              (d[2].first_line = g[0]),
                              (d[2].first_column = g[1])),
                            e &&
                              ((t = c.lastIndexOf(':')),
                              this.token(':', ':', t, e.length)),
                            c.length))
                      : 0
                  }),
                  (e.prototype.numberToken = function() {
                    var e, t, n, i, r
                    return (n = A.exec(this.chunk))
                      ? ((i = n[0]),
                        /^0[BOX]/.test(i)
                          ? this.error(
                              "radix prefix '" + i + "' must be lowercase"
                            )
                          : /E/.test(i) && !/^0x/.test(i)
                          ? this.error(
                        ...
                        (t = i.length),
                        (r = /^0o([0-7]+)/.exec(i)) &&
                          (i = '0x' + parseInt(r[1], 8).toString(16)),
                        (e = /^0b([01]+)/.exec(i)) &&
                          (i = '0x' + parseInt(e[1], 2).toString(16)),
                  ...
                  (e.prototype.stringToken = function() {
                    ...
                    return (
                      (i = /^(?:\\.|[^\\])*\\(?:0[0-7]|[1-7])/.test(o)) &&
                        this.error(
                          'octal escape sequences ' + o + ' are not allowed'
                        ),
                      o.length
                    )
                  }),
                  (e.prototype.heredocToken = function() {
                    var e, t, n, i, r
                    return (n = u.exec(this.chunk))
                      ? ((t = n[0]),
                        (i = t.charAt(0)),
                        (e = this.sanitizeHeredoc(n[2], {
                          quote: i,
                          indent: null
                        })),
                        '"' === i && e.indexOf('#{') >= 0
                          ? ((r = '\n' === n[2].charAt(0) ? 4 : 3),
                            this.interpolateString(e, {
                              heredoc: !0,
                              strOffset: r,
                  ...
                  (e.prototype.commentToken = function() {
                    var e, t, n
                    return (n = this.chunk.match(c))
                      ? ((e = n[0]),
                        (t = n[1]),
                        t &&
                          this.token(
                            'HERECOMMENT',
                            this.sanitizeHeredoc(t, {
                              herecomment: !0,
                              indent: J(' ', this.indent)
                            }),
                            0,
                            e.length
                          ),
                  ...
                  (e.prototype.jsToken = function() {
                    ...
                    return '`' === this.chunk.charAt(0) &&
                      (e = v.exec(this.chunk))
                      ? (this.token('JS', (t = e[0]).slice(1, -1), 0, t.length),
                        t.length)
                      : 0
                  }),
                  (e.prototype.regexToken = function() {
                    ...
                    return '/' !== this.chunk.charAt(0)
                      ...
                      ? t
                      : ((i = z(this.tokens)),
                        i && ((s = i[0]), nt.call(i.spaced ? S : R, s) >= 0)
                          ? 0
                          : (n = _.exec(this.chunk))
                          ? ((o = n),
                            (n = o[0]),
                            ...
                            '//' === r
                              ...
                              : ('/*' === r.slice(0, 2) &&
                                ...
                                this.token('REGEX', '' + r + e, 0, n.length),
                                n.length))
                          : 0)
                  }),
                  (e.prototype.heregexToken = function() {
                    var e, t, n, i, r, s, o, a, c, h, l, u, p, d, b, g, k
                    if (!(r = f.exec(this.chunk))) return 0
                    if (
                      ((i = r[0]), (e = r[1]), (t = r[2]), 0 > e.indexOf('#{'))
                    )
                      return (
                        (a = this.escapeLines(
                          e.replace(m, '$1$2').replace(/\//g, '\\/'),
                          !0
                        )),
                        a.match(/^\*/) &&
                          this.error(
                    ...
                    for (
                      ...
                      if (((h = b[p]), (c = h[0]), (u = h[1]), 'TOKENS' === c))
                        ...
                        if (!(u = u.replace(m, '$1$2'))) continue
                        ;(u = u.replace(/\\/g, '\\\\')),
                          (h[0] = 'STRING'),
                          (h[1] = this.makeString(u, '"', !0)),
                          l.push(h)
                      } else this.error('Unexpected ' + c)
                      ;(o = z(this.tokens)),
                        (s = ['+', '+']),
                        (s[2] = o[2]),
                        l.push(s)
                    ...
                    return (
                      l.pop(),
                      'STRING' !== (null != (g = l[0]) ? g[0] : void 0) &&
                        (this.token('STRING', '""', 0, 0),
                        this.token('+', '+', 0, 0)),
                      (k = this.tokens).push.apply(k, l),
                      t &&
                        ((n = i.lastIndexOf(t)),
                        this.token(',', ',', n, 0),
                        this.token('STRING', '"' + t + '"', n, t.length)),
                      this.token(')', ')', i.length - 1, 0),
                      i.length
                    )
                  }),
                  (e.prototype.lineToken = function() {
                    var e, t, n, i, r
                    if (!(n = D.exec(this.chunk))) return 0
                    if (
                      ((t = n[0]),
                      (this.seenFor = !1),
                      (r = t.length - 1 - t.lastIndexOf('\n')),
                      (i = this.unfinished()),
                      r - this.indebt === this.indent)
                    )
                      return (
                        i ? this.suppressNewlines() : this.newlineToken(0),
                        t.length
                      )
                    if (r > this.indent) {
                      if (i)
                        return (
                          (this.indebt = r - this.indent),
                          this.suppressNewlines(),
                          t.length
                        )
                      if (!this.tokens.length)
                        return (this.baseIndent = this.indent = r), t.length
                      ;(e = r - this.indent + this.outdebt),
                        this.token('INDENT', e, t.length - r, r),
                        this.indents.push(e),
                      ...
                      this.baseIndent > r
                        ? this.error('missing indentation', t.length)
                        : ((this.indebt = 0),
                          this.outdentToken(this.indent - r, i, t.length))
                    return t.length
                  }),
                  (e.prototype.outdentToken = function(e, t, n) {
                    ...
                    for (i = this.indent - e; e > 0; )
                      (s = this.indents[this.indents.length - 1]),
                        s
                          ? s === this.outdebt
                            ? ((e -= this.outdebt), (this.outdebt = 0))
                            : this.outdebt > s
                            ? ((this.outdebt -= s), (e -= s))
                            : ((r = this.indents.pop() + this.outdebt),
                              n &&
                                ((o = this.chunk[n]), nt.call(g, o) >= 0) &&
                                ((i -= r - e), (e = r)),
                              (this.outdebt = 0),
                              this.pair('OUTDENT'),
                  ...
                  (e.prototype.literalToken = function() {
                    ...
                    if (
                      ((e = I.exec(this.chunk))
                        ? ((s = e[0]), r.test(s) && this.tagParameters())
                        : (s = this.chunk.charAt(0)),
                      (n = s),
                      (t = z(this.tokens)),
                      '=' === s &&
                        t &&
                    ...
                    else if (nt.call(E, s) >= 0) n = 'MATH'
                    else if (nt.call(h, s) >= 0) n = 'COMPARE'
                    else if (nt.call(l, s) >= 0) n = 'COMPOUND_ASSIGN'
                    else if (nt.call(U, s) >= 0) n = 'UNARY'
                    else if (nt.call(H, s) >= 0) n = 'UNARY_MATH'
                    else if (nt.call(M, s) >= 0) n = 'SHIFT'
                    else if (
                      nt.call(C, s) >= 0 ||
                      ('?' === s && (null != t ? t.spaced : void 0))
                    )
                      n = 'LOGIC'
                    else if (t && !t.spaced)
                  ...
                  (e.prototype.sanitizeHeredoc = function(e, t) {
                    ...
                    if (((r = t.indent), (i = t.herecomment))) {
                      if (
                        (p.test(e) &&
                          this.error(
                            'block comment cannot contain "*/", starting'
                          ),
                        0 > e.indexOf('\n'))
                      )
                        return e
                    ...
                    for (
                      ...
                      if (n) --n
                        ...
                        '}' !== t || ('"' !== r && "'" !== r)
                          ? '}' === t &&
                            '/' === r &&
                            (s = f.exec(e.slice(i)) || _.exec(e.slice(i)))
                            ? (n += s[0].length - 1)
                            : '}' === t && '{' === r
                            ? a.push((t = '}'))
                            : '"' === t &&
                  ...
                  (e.prototype.interpolateString = function(t, n) {
                    ...
                    for (
                      ...
                      '\\' !== u
                        ? '#' === u &&
                          '{' === t.charAt(a + 1) &&
                          (s = this.balancedString(t.slice(a + 1), '}')) &&
                          (a > g &&
                            C.push(
                              this.makeToken('NEOSTRING', t.slice(g, a), T + g)
                            ),
                          r ||
                            (r = this.makeToken(
                              '',
                          ...
                          (c = s.slice(1, -1)),
                          c.length &&
                            ((D = this.getLineAndColumnFromChunk(T + a + 2)),
                            (d = D[0]),
                            (i = D[1]),
                            (m = new e().tokenize(c, {
                              line: d,
                            ...
                            (y = m.pop()),
                            'TERMINATOR' ===
                              (null != (S = m[0]) ? S[0] : void 0) &&
                              (y = m.shift()),
                            (l = m.length) &&
                              (l > 1 &&
                                (m.unshift(
                                  this.makeToken('(', '(', T + a + 1, 0)
                                ),
                                m.push(
                                  this.makeToken(
                                    ')',
                    ...
                    if (
                      (a > g &&
                        t.length > g &&
                        C.push(this.makeToken('NEOSTRING', t.slice(g), T + g)),
                      v)
                    )
                      return C
                    if (!C.length) return this.token('STRING', '""', b, p)
                    for (
                      'NEOSTRING' !== C[0][0] &&
                        C.unshift(this.makeToken('NEOSTRING', '', b)),
                        (h = C.length > 1) && this.token('(', '(', b, 0, r),
                        a = E = 0,
                        x = C.length;
                      x > E;
                      a = ++E
                      ...
                      (L = C[a]),
                        ...
                        'TOKENS' === F
                          ? (R = this.tokens).push.apply(R, N)
                          : 'NEOSTRING' === F
                          ? ((L[0] = 'STRING'),
                            (L[1] = this.makeString(N, '"', o)),
                            this.tokens.push(L))
                          : this.error('Unexpected ' + F)
                    return (
                      h &&
                        ((w = this.makeToken(')', ')', b + p, 0)),
                        (w.stringEnd = !0),
                        this.tokens.push(w)),
                      C
                    )
                  ...
                  (e.prototype.pair = function(e) {
                    var t
                    return e !== (t = z(this.ends))
                      ? ('OUTDENT' !== t && this.error('unmatched ' + e),
                        this.outdentToken(z(this.indents), !0),
                        this.pair(e))
                      : this.ends.pop()
                  }),
                  ...
                  (e.prototype.makeToken = function(e, t, n, i) {
                    ...
                    return (
                      ...
                      null == i && (i = t.length),
                      (s = {}),
                      (a = this.getLineAndColumnFromChunk(n)),
                      (s.first_line = a[0]),
                      (s.first_column = a[1]),
                      (r = Math.max(0, i - 1)),
                      (c = this.getLineAndColumnFromChunk(n + r)),
                      (s.last_line = c[0]),
                      (s.last_column = c[1]),
                      (o = [e, t, s])
                    )
                  ...
                  (e.prototype.error = function(e, t) {
                    ...
                    return (
                      null == t && (t = 0),
                      (r = this.getLineAndColumnFromChunk(t)),
                      (i = r[0]),
                      (n = r[1]),
                      Q(e, { first_line: i, first_column: n })
                    )
                  }),
                  e
                )
              ...
              (V = ['arguments', 'eval']),
              (w = T.concat(O).concat(V)),
              (e.RESERVED = O.concat(T)
                .concat(a)
                .concat(V)),
              (e.STRICT_PROSCRIBED = V),
              (t = 65279),
              (b = /^([$A-Za-z_\x7f-\uffff][$\w\x7f-\uffff]*)([^\n\S]*:(?!:))?/),
              (A = /^0b[01]+|^0o[0-7]+|^0x[\da-f]+|^\d*\.?\d+(?:e[+-]?\d+)?/i),
              (u = /^("""|''')((?:\\[\s\S]|[^\\])*?)(?:\n[^\n\S]*)?\1/),
              (I = /^(?:[-=]>|[-+*\/%<>&|^!?=]=|>>>=?|([-+:])\1|([&|<>*\/%])\2=?|\?(\.|::)|\.{2,3})/),
              (q = /^[^\n\S]+/),
              (c = /^###([^#][\s\S]*?)(?:###[^\n\S]*|###$)|^(?:\s*#(?!##[^#]).*)+/),
              ...
              (R = S.concat(')', '}', 'THIS', 'IDENTIFIER', 'STRING', ']')),
              (i = [
                'IDENTIFIER',
                'STRING',
                'REGEX',
              ...
              (k = i.concat('NUMBER', 'BOOL', 'NULL', 'UNDEFINED')),
              (F = ['INDENT', 'OUTDENT', 'TERMINATOR']),
              (g = [')', '}', ']'])
          }.call(this),
          t.exports
        )
          ...
          n = (function() {
            ...
            var t = {
              ...
              performAction: function(e, t, n, i, r, s, o) {
                ...
                switch (r) {
                  case 1:
                    return (this.$ = i.addLocationDataFn(o[a], o[a])(
                      new i.Block()
                    ))
                  case 2:
                    return (this.$ = s[a])
                  case 3:
                    ...
                    break
                  case 4:
                    this.$ = i.addLocationDataFn(o[a - 2], o[a])(
                      s[a - 2].push(s[a])
                    )
                    break
                  case 5:
                  ...
                  case 35:
                    this.$ = i.addLocationDataFn(o[a - 2], o[a])(
                      new i.Assign(s[a - 2], s[a])
                    )
                    break
                  case 36:
                    this.$ = i.addLocationDataFn(o[a - 3], o[a])(
                      new i.Assign(s[a - 3], s[a])
                    )
                    break
                  case 37:
                    this.$ = i.addLocationDataFn(o[a - 4], o[a])(
                      new i.Assign(s[a - 4], s[a - 1])
                    )
                    break
                  case 38:
                  ...
                  case 39:
                    this.$ = i.addLocationDataFn(o[a - 2], o[a])(
                      new i.Assign(
                        i.addLocationDataFn(o[a - 2])(new i.Value(s[a - 2])),
                        s[a],
                        'object'
                      )
                    )
                  ...
                  case 40:
                    this.$ = i.addLocationDataFn(o[a - 4], o[a])(
                      new i.Assign(
                        i.addLocationDataFn(o[a - 4])(new i.Value(s[a - 4])),
                        s[a - 1],
                        'object'
                      )
                    )
                  ...
                  case 48:
                    this.$ = i.addLocationDataFn(o[a - 4], o[a])(
                      new i.Code(s[a - 3], s[a], s[a - 1])
                    )
                    break
                  case 49:
                    this.$ = i.addLocationDataFn(o[a - 1], o[a])(
                      new i.Code([], s[a], s[a - 1])
                    )
                    break
                  case 50:
                  ...
                  case 60:
                    this.$ = i.addLocationDataFn(o[a - 1], o[a])(
                      new i.Param(s[a - 1], null, !0)
                    )
                    break
                  case 61:
                    this.$ = i.addLocationDataFn(o[a - 2], o[a])(
                      new i.Param(s[a - 2], s[a])
                    )
                    break
                  case 62:
                  ...
                  case 81:
                    this.$ = i.addLocationDataFn(o[a - 1], o[a])(
                      new i.Access(s[a], 'soak')
                    )
                    break
                  case 82:
                    this.$ = i.addLocationDataFn(o[a - 1], o[a])([
                      i.addLocationDataFn(o[a - 1])(
                        new i.Access(new i.Literal('prototype'))
                      ),
                      i.addLocationDataFn(o[a])(new i.Access(s[a]))
                    ])
                    break
                  case 83:
                    this.$ = i.addLocationDataFn(o[a - 1], o[a])([
                      i.addLocationDataFn(o[a - 1])(
                        new i.Access(new i.Literal('prototype'), 'soak')
                      ),
                      i.addLocationDataFn(o[a])(new i.Access(s[a]))
                    ])
                    break
                  ...
                  case 90:
                    this.$ = i.addLocationDataFn(o[a - 3], o[a])(
                      new i.Obj(s[a - 2], s[a - 3].generated)
                    )
                    break
                  case 91:
                    this.$ = i.addLocationDataFn(o[a], o[a])([])
                  ...
                  case 97:
                    this.$ = i.addLocationDataFn(o[a - 1], o[a])(
                      new i.Class(null, null, s[a])
                    )
                    break
                  case 98:
                    this.$ = i.addLocationDataFn(o[a - 2], o[a])(
                      new i.Class(null, s[a])
                    )
                    break
                  case 99:
                    this.$ = i.addLocationDataFn(o[a - 3], o[a])(
                      new i.Class(null, s[a - 1], s[a])
                    )
                    break
                  case 100:
                    this.$ = i.addLocationDataFn(o[a - 1], o[a])(
                  ...
                  case 101:
                    this.$ = i.addLocationDataFn(o[a - 2], o[a])(
                      new i.Class(s[a - 1], null, s[a])
                    )
                    break
                  case 102:
                    this.$ = i.addLocationDataFn(o[a - 3], o[a])(
                      new i.Class(s[a - 2], s[a])
                    )
                    break
                  case 103:
                    this.$ = i.addLocationDataFn(o[a - 4], o[a])(
                      new i.Class(s[a - 3], s[a - 1], s[a])
                    )
                    break
                  case 104:
                    this.$ = i.addLocationDataFn(o[a - 2], o[a])(
                      new i.Call(s[a - 2], s[a], s[a - 1])
                    )
                    break
                  case 105:
                    this.$ = i.addLocationDataFn(o[a - 2], o[a])(
                  ...
                  case 106:
                    this.$ = i.addLocationDataFn(o[a], o[a])(
                      new i.Call('super', [
                        new i.Splat(new i.Literal('arguments'))
                      ])
                    )
                    break
                  case 107:
                    this.$ = i.addLocationDataFn(o[a - 1], o[a])(
                      new i.Call('super', s[a])
                    )
                    break
                  case 108:
                  ...
                  case 112:
                    this.$ = i.addLocationDataFn(o[a], o[a])(
                      new i.Value(new i.Literal('this'))
                    )
                    break
                  case 113:
                    this.$ = i.addLocationDataFn(o[a], o[a])(
                  ...
                  case 114:
                    this.$ = i.addLocationDataFn(o[a - 1], o[a])(
                      new i.Value(
                        i.addLocationDataFn(o[a - 1])(new i.Literal('this')),
                        [i.addLocationDataFn(o[a])(new i.Access(s[a]))],
                        'this'
                      )
                    )
                  ...
                  case 119:
                    this.$ = i.addLocationDataFn(o[a - 4], o[a])(
                      new i.Range(s[a - 3], s[a - 1], s[a - 2])
                    )
                    break
                  case 120:
                    this.$ = i.addLocationDataFn(o[a - 2], o[a])(
                      new i.Range(s[a - 2], s[a], s[a - 1])
                    )
                    break
                  case 121:
                    this.$ = i.addLocationDataFn(o[a - 1], o[a])(
                      new i.Range(s[a - 1], null, s[a])
                    )
                    break
                  case 122:
                    this.$ = i.addLocationDataFn(o[a - 1], o[a])(
                      new i.Range(null, s[a], s[a - 1])
                    )
                    break
                  case 123:
                    this.$ = i.addLocationDataFn(o[a], o[a])(
                      new i.Range(null, null, s[a])
                    )
                    break
                  case 124:
                    this.$ = i.addLocationDataFn(o[a], o[a])([s[a]])
                  ...
                  case 135:
                    this.$ = i.addLocationDataFn(o[a - 2], o[a])(
                      new i.Try(s[a - 1], s[a][0], s[a][1])
                    )
                    break
                  case 136:
                    this.$ = i.addLocationDataFn(o[a - 3], o[a])(
                      new i.Try(s[a - 2], null, null, s[a])
                    )
                    break
                  case 137:
                    this.$ = i.addLocationDataFn(o[a - 4], o[a])(
                      new i.Try(s[a - 3], s[a - 2][0], s[a - 2][1], s[a])
                    )
                    break
                  case 138:
                    this.$ = i.addLocationDataFn(o[a - 2], o[a])([
                  ...
                  case 139:
                    this.$ = i.addLocationDataFn(o[a - 2], o[a])([
                      i.addLocationDataFn(o[a - 1])(new i.Value(s[a - 1])),
                      s[a]
                    ])
                    break
                  case 140:
                  ...
                  case 145:
                    this.$ = i.addLocationDataFn(o[a - 3], o[a])(
                      new i.While(s[a - 2], { guard: s[a] })
                    )
                    break
                  case 146:
                    this.$ = i.addLocationDataFn(o[a - 1], o[a])(
                      new i.While(s[a], { invert: !0 })
                    )
                    break
                  case 147:
                    this.$ = i.addLocationDataFn(o[a - 3], o[a])(
                      new i.While(s[a - 2], { invert: !0, guard: s[a] })
                    )
                    break
                  case 148:
                    this.$ = i.addLocationDataFn(o[a - 1], o[a])(
                  ...
                  case 149:
                    this.$ = i.addLocationDataFn(o[a - 1], o[a])(
                      s[a].addBody(
                        i.addLocationDataFn(o[a - 1])(i.Block.wrap([s[a - 1]]))
                      )
                    )
                    break
                  case 150:
                  ...
                  case 152:
                    this.$ = i.addLocationDataFn(o[a - 1], o[a])(
                      new i.While(
                        i.addLocationDataFn(o[a - 1])(new i.Literal('true'))
                      ).addBody(s[a])
                    )
                    break
                  case 153:
                    this.$ = i.addLocationDataFn(o[a - 1], o[a])(
                      new i.While(
                        i.addLocationDataFn(o[a - 1])(new i.Literal('true'))
                      ).addBody(i.addLocationDataFn(o[a])(i.Block.wrap([s[a]])))
                    )
                    break
                  case 154:
                    this.$ = i.addLocationDataFn(o[a - 1], o[a])(
                  ...
                  case 174:
                    this.$ = i.addLocationDataFn(o[a - 4], o[a])(
                      new i.Switch(s[a - 3], s[a - 1])
                    )
                    break
                  case 175:
                    this.$ = i.addLocationDataFn(o[a - 6], o[a])(
                      new i.Switch(s[a - 5], s[a - 3], s[a - 1])
                    )
                    break
                  case 176:
                    this.$ = i.addLocationDataFn(o[a - 3], o[a])(
                      new i.Switch(null, s[a - 1])
                    )
                    break
                  case 177:
                    this.$ = i.addLocationDataFn(o[a - 5], o[a])(
                      new i.Switch(null, s[a - 3], s[a - 1])
                    )
                    break
                  case 178:
                    this.$ = s[a]
                  ...
                  case 182:
                    this.$ = i.addLocationDataFn(o[a - 2], o[a])(
                      new i.If(s[a - 1], s[a], { type: s[a - 2] })
                    )
                    break
                  case 183:
                    this.$ = i.addLocationDataFn(o[a - 4], o[a])(
                      s[a - 4].addElse(
                        i.addLocationDataFn(o[a - 2], o[a])(
                          new i.If(s[a - 1], s[a], { type: s[a - 2] })
                        )
                      )
                    )
                  ...
                  case 186:
                    this.$ = i.addLocationDataFn(o[a - 2], o[a])(
                      new i.If(
                        s[a],
                        i.addLocationDataFn(o[a - 2])(i.Block.wrap([s[a - 2]])),
                        { type: s[a - 1], statement: !0 }
                      )
                    )
                    break
                  case 187:
                  ...
                  case 204:
                    this.$ = i.addLocationDataFn(o[a - 2], o[a])(
                      (function() {
                        return '!' === s[a - 1].charAt(0)
                          ? new i.Op(s[a - 1].slice(1), s[a - 2], s[a]).invert()
                          : new i.Op(s[a - 1], s[a - 2], s[a])
                      })()
                    )
                    break
                  case 205:
                    this.$ = i.addLocationDataFn(o[a - 2], o[a])(
                      new i.Assign(s[a - 2], s[a], s[a - 1])
                    )
                    break
                  case 206:
                    this.$ = i.addLocationDataFn(o[a - 4], o[a])(
                      new i.Assign(s[a - 4], s[a - 1], s[a - 3])
                    )
                    break
                  case 207:
                    this.$ = i.addLocationDataFn(o[a - 3], o[a])(
                      new i.Assign(s[a - 3], s[a], s[a - 2])
                    )
                    break
                  case 208:
                    this.$ = i.addLocationDataFn(o[a - 2], o[a])(
                      new i.Extends(s[a - 2], s[a])
                    )
                }
              },
              table: [
                ...
                { 6: [2, 52], 25: [2, 52], 53: 231, 54: [1, 232], 91: [2, 52] },
                {
                  6: [2, 124],
                  25: [2, 124],
                  26: [2, 124],
                ...
                { 54: [1, 238], 116: [2, 165], 117: [2, 165] },
                { 54: [2, 161], 116: [2, 161], 117: [2, 161] },
                { 54: [2, 162], 116: [2, 162], 117: [2, 162] },
                { 54: [2, 163], 116: [2, 163], 117: [2, 163] },
                { 54: [2, 164], 116: [2, 164], 117: [2, 164] },
                {
                  1: [2, 158],
                  6: [2, 158],
                  25: [2, 158],
                ...
                { 6: [2, 52], 25: [2, 52], 53: 241, 54: [1, 242], 78: [2, 52] },
                {
                  6: [2, 92],
                  25: [2, 92],
                  26: [2, 92],
                ...
                { 6: [2, 52], 25: [2, 52], 53: 249, 54: [1, 232], 86: [2, 52] },
                {
                  6: [2, 129],
                  25: [2, 129],
                  26: [2, 129],
                ...
                { 120: 265, 122: 222, 123: [1, 223] },
                { 26: [1, 266], 121: [1, 267], 122: 268, 123: [1, 223] },
                { 26: [2, 178], 121: [2, 178], 123: [2, 178] },
                {
                  7: 270,
                  8: 117,
                  9: 18,
                ...
                { 6: [2, 52], 25: [2, 52], 26: [2, 52], 53: 279, 54: [1, 232] },
                {
                  1: [2, 182],
                  6: [2, 182],
                  25: [2, 182],
                ...
                { 26: [1, 303], 121: [1, 304], 122: 268, 123: [1, 223] },
                {
                  1: [2, 176],
                  6: [2, 176],
                  25: [2, 176],
                ...
                { 24: 305, 25: [1, 115] },
                { 26: [2, 179], 121: [2, 179], 123: [2, 179] },
                { 24: 306, 25: [1, 115], 54: [1, 307] },
                {
                  25: [2, 132],
                  54: [2, 132],
                  103: 84,
                ...
                { 6: [2, 52], 25: [2, 52], 26: [2, 52], 53: 320, 54: [1, 205] },
                {
                  1: [2, 206],
                  6: [2, 206],
                  25: [2, 206],
                ...
                { 24: 321, 25: [1, 115] },
                { 26: [1, 322] },
                { 6: [1, 323], 26: [2, 180], 121: [2, 180], 123: [2, 180] },
                {
                  7: 324,
                  8: 117,
                  9: 18,
                ...
                { 6: [2, 52], 25: [2, 52], 26: [2, 52], 53: 325, 54: [1, 232] },
                {
                  6: [2, 127],
                  25: [2, 127],
                  26: [2, 127],
                ...
                { 6: [2, 52], 25: [2, 52], 26: [2, 52], 53: 328, 54: [1, 242] },
                {
                  26: [1, 329],
                  103: 84,
                  104: [1, 64],
                ...
                for (var b, g, k, y, v, w, T, F, L, C = {}; ; ) {
                  if (
                    ...
                    this.defaultActions[k]
                      ? (y = this.defaultActions[k])
                      : ((null === b || b === void 0) && (b = t()),
                        (y = o[k] && o[k][b])),
                    y === void 0 || !y.length || !y[0])
                  ) {
                    var N = ''
                    L = []
                    for (w in o[k])
                      this.terminals_[w] &&
                        w > u &&
                        L.push("'" + this.terminals_[w] + "'")
                    ;(N = this.lexer.showPosition
                      ? 'Parse error on line ' +
                        (c + 1) +
                        ':\n' +
                  ...
                  switch (y[0]) {
                    ...
                    case 2:
                      if (
                        ...
                        m &&
                          (C._$.range = [
                            s[s.length - (T || 1)].range[0],
                            s[s.length - 1].range[1]
                          ]),
                        (v = this.performAction.apply(
                          C,
                          [a, h, c, this.yy, y[1], r, s].concat(d)
                        )),
                        v !== void 0)
                      )
                        return v
        ...
        return (
          require !== void 0 &&
            ...
            (e.main = function(t) {
              ...
              var n = require('fs').readFileSync(
                require('path').normalize(t[1]),
                'utf8'
              )
                ...
                return (
                  ...
                  (e.prototype.add = function(e, t, n) {
                    return this.shared && !n
                      ...
                      : Object.prototype.hasOwnProperty.call(this.positions, e)
                      ? (this.variables[this.positions[e]].type = t)
                      : (this.positions[e] =
                          this.variables.push({ name: e, type: t }) - 1)
                  }),
                  (e.prototype.namedMethod = function() {
                    var e
                    return (null != (e = this.method) ? e.name : void 0) ||
                      !this.parent
                      ? this.method
                  ...
                  (e.prototype.temporary = function(e, t) {
                    return e.length > 1
                      ? '_' + e + (t > 1 ? t - 1 : '')
                      : '_' +
                          (t + parseInt(e, 36)).toString(36).replace(/\d/g, 'a')
                  }),
                  (e.prototype.type = function(e) {
                    var t, n, i, r
                    for (r = this.variables, n = 0, i = r.length; i > n; n++)
                      if (((t = r[n]), t.name === e)) return t.type
                    return null
                  }),
                  (e.prototype.freeVariable = function(e, t) {
                    ...
                    for (
                      null == t && (t = !0), n = 0;
                      this.check((i = this.temporary(e, n)));
                  ...
                  (e.prototype.declaredVariables = function() {
                    var e, t, n, i, r, s
                    for (
                      e = [], t = [], s = this.variables, i = 0, r = s.length;
                      r > i;
                      i++
                    )
                      (n = s[i]),
                        'var' === n.type &&
                          ('_' === n.name.charAt(0) ? t : e).push(n.name)
                    return e.sort().concat(t.sort())
                  }),
                  (e.prototype.assignedVariables = function() {
                    var e, t, n, i, r
                    for (
                      i = this.variables, r = [], t = 0, n = i.length;
                      n > t;
                      t++
                    )
                      (e = i[t]),
                        e.type.assigned &&
                          r.push('' + e.name + ' = ' + e.type.value)
                    return r
                  }),
                  e
                )
          ...
          function() {
            var t,
              ...
              Ft = function(e, t) {
                ...
                for (var i in t) Tt.call(t, i) && (e[i] = t[i])
                return (
            ...
            ;(Error.stackTraceLimit = 1 / 0),
              (H = require('./scope').Scope),
              (vt = require('./lexer')),
              (M = vt.RESERVED),
              (U = vt.STRICT_PROSCRIBED),
              (wt = require('./helpers')),
              (nt = wt.compact),
              (ot = wt.flatten),
              (st = wt.extend),
              ...
              (lt = wt.last),
              (mt = wt.some),
              (tt = wt.addLocationDataFn),
              (ut = wt.locationDataToString),
              (gt = wt.throwSyntaxError),
              (e.extend = st),
              (e.addLocationDataFn = tt),
              (et = function() {
                return !0
              }),
              (A = function() {
                ...
                return (
                  (e.prototype.toString = function() {
                    return (
                      '' +
                      this.code +
                      (this.locationData ? ': ' + ut(this.locationData) : '')
                    )
                  }),
                  e
                )
              ...
              (e.Base = r = (function() {
                ...
                return (
                  ...
                  (e.prototype.compileClosure = function(e) {
                    ...
                    return (
                      (a = this.jumps()) &&
                        a.error('cannot use a pure statement in an expression'),
                      (e.sharedScope = !0),
                      (r = new c([], s.wrap([this]))),
                      (n = []),
                      ((i = this.contains(ct)) || this.contains(ht)) &&
                        ((n = [new D('this')]),
                        i
                          ? ((h = 'apply'), n.push(new D('arguments')))
                          : (h = 'call'),
                        (r = new Z(r, [new t(new D(h))]))),
                      new o(r, n).compileNode(e)
                    )
                  }),
                  (e.prototype.cache = function(e, t, n) {
                    var r, s
                    return this.isComplex()
                      ? ((r = new D(n || e.scope.freeVariable('ref'))),
                        (s = new i(r, this)),
                        t
                          ? [
                              s.compileToFragments(e, t),
                              [this.makeCode(r.value)]
                            ]
                          : [s, r])
                      : ((r = t ? this.compileToFragments(e, t) : this), [r, r])
                  }),
                  ...
                  (e.prototype.makeReturn = function(e) {
                    ...
                    return (
                      (t = this.unwrapAll()),
                      e ? new o(new D('' + e + '.push'), [t]) : new V(t)
                    )
                  }),
                  ...
                  (e.prototype.traverseChildren = function(e, t) {
                    return this.eachChild(function(n) {
                      var i
                      return (
                        (i = t(n)), i !== !1 ? n.traverseChildren(e, t) : void 0
                      )
                    })
                  }),
                  ...
                  (e.prototype.isStatement = A),
                  (e.prototype.jumps = A),
                  (e.prototype.isComplex = et),
                  (e.prototype.isChainable = A),
                  (e.prototype.isAssignable = A),
                  (e.prototype.unwrap = Y),
                  (e.prototype.unfoldSoak = A),
                  (e.prototype.assigns = A),
                ...
                return (
                  ...
                  (t.prototype.compileToFragments = function(e, n) {
                    return (
                      null == e && (e = {}),
                      e.scope
                        ? t.__super__.compileToFragments.call(this, e, n)
                        : this.compileRoot(e)
                    )
                  }),
                  (t.prototype.compileNode = function(e) {
                    ...
                    for (
                      ...
                      (o = l[s]),
                        ...
                        (o = o.unfoldSoak(e) || o),
                        o instanceof t
                          ? i.push(o.compileNode(e))
                          : a
                          ? ((o.front = !0),
                            (r = o.compileToFragments(e)),
                            o.isStatement(e) ||
                              (r.unshift(this.makeCode('' + this.tab)),
                              r.push(this.makeCode(';'))),
                            i.push(r))
                          : i.push(o.compileToFragments(e, C))
                    return a
                      ? this.spaced
                        ? [].concat(
                      ...
                      : ((n = i.length
                        ...
                        i.length > 1 && e.level >= C ? this.wrapInBraces(n) : n)
                  }),
                        ...
                        ((o = function() {
                          ...
                          for (
                            r = this.expressions,
                              ...
                              i = e = 0,
                              n = r.length;
                            n > e && ((t = r[i]), t.unwrap() instanceof l);
                            i = ++e
                          )
                            s.push(t)
                          return s
                        }.call(this)),
                        (a = this.expressions.slice(o.length)),
                        (this.expressions = o),
                        o.length &&
                          ((s = this.compileNode(pt(e, { indent: '' }))),
                  ...
                  (t.prototype.compileWithDeclarations = function(e) {
                    ...
                    for (
                      ...
                      ((i = d[s]),
                      (i = i.unwrap()),
                      i instanceof l || i instanceof D);
                      s = ++u
                    );
                    return (
                      (e = pt(e, { level: x })),
                      s &&
                        ((a = this.expressions.splice(s, 9e9)),
                        (f = [this.spaced, !1]),
                        (h = f[0]),
                        (this.spaced = f[1]),
                        (m = [this.compileNode(e), h]),
                        (r = m[0]),
                        (this.spaced = m[1]),
                        (this.expressions = a)),
                      (o = this.compileNode(e)),
                      (c = e.scope),
                      c.expressions === this &&
                        ...
                        n || t
                          ? (s && r.push(this.makeCode('\n')),
                            ...
                            n &&
                              r.push(
                                this.makeCode(c.declaredVariables().join(', '))
                              ),
                            t &&
                              (n &&
                                r.push(this.makeCode(',\n' + (this.tab + X))),
              ...
              (e.Return = V = (function(e) {
                ...
                return (
                  ...
                  (t.prototype.isStatement = et),
                  (t.prototype.makeReturn = Y),
                  (t.prototype.jumps = Y),
                  (t.prototype.compileToFragments = function(e, n) {
                    var i, r
                    return (
                  ...
                  (t.prototype.compileNode = function(e) {
                    ...
                    return (
                      ...
                      t.push(
                        this.makeCode(
                          this.tab + ('return' + (this.expression ? ' ' : ''))
                        )
                      ),
                      this.expression &&
                        (t = t.concat(
                          this.expression.compileToFragments(e, E)
                        )),
              ...
              (e.Value = Z = (function(e) {
                ...
                return (
                  ...
                  (t.prototype.isAtomic = function() {
                    var e, t, n, i
                    for (
                      i = this.properties.concat(this.base),
                        t = 0,
                        n = i.length;
                      n > t;
                      t++
                    )
                      if (((e = i[t]), e.soak || e instanceof o)) return !1
                    return !0
                  }),
                  ...
                  (t.prototype.isObject = function(e) {
                    return this.properties.length
                      ? !1
                      : this.base instanceof _ && (!e || this.base.generated)
                  }),
                  ...
                  (t.prototype.cacheReference = function(e) {
                    var n, r, s, o
                    return (
                      (s = lt(this.properties)),
                      2 > this.properties.length &&
                      !this.base.isComplex() &&
                      !(null != s ? s.isComplex() : void 0)
                        ? [this, this]
                        : ((n = new t(this.base, this.properties.slice(0, -1))),
                          n.isComplex() &&
                            ((r = new D(e.scope.freeVariable('base'))),
                            (n = new t(new j(new i(r, n))))),
                          s
                            ? (s.isComplex() &&
                                ((o = new D(e.scope.freeVariable('name'))),
                                (s = new T(new i(o, s.index))),
                                (o = new T(o))),
                              [n.add(s), new t(r || n.base, [o || s])])
                            : [n, r])
                    )
                  }),
                  (t.prototype.compileNode = function(e) {
                    ...
                    for (
                      this.base.front = this.front,
                        ...
                        (this.base instanceof j || i.length) &&
                          P.test(at(t)) &&
                          t.push(this.makeCode('.')),
                        r = 0,
                        s = i.length;
                      ...
                      : (this.unfoldedSoak = (function(n) {
                          return function() {
                            ...
                            if ((o = n.base.unfoldSoak(e)))
                              return (
                                (d = o.body.properties).push.apply(
                                  d,
                                  n.properties
                                ),
                                o
                            ...
                            for (
                              f = n.properties, s = l = 0, p = f.length;
                              p > l;
                              s = ++l
                            )
                              if (((a = f[s]), a.soak))
                                return (
                                  ...
                                  (h = new t(n.base, n.properties.slice(s))),
                                  r.isComplex() &&
                                    ((c = new D(e.scope.freeVariable('ref'))),
                                    (r = new j(new i(c, r))),
                                    (h.base = c)),
                                  new v(new u(r), h, { soak: !0 })
                                )
                            return !1
                          }
                        })(this)())
              ...
              (e.Comment = l = (function(e) {
                ...
                return (
                  ...
                  (t.prototype.compileNode = function(e, t) {
                    var n, i
                    return (
                      (i = this.comment.replace(/^(\s*)#/gm, '$1 *')),
                      (n =
                        '/*' +
                        dt(i, this.tab) +
                        (Lt.call(i, '\n') >= 0 ? '\n' + this.tab : '') +
                        ' */'),
                      (t || e.level) === x && (n = e.indent + n),
                      [this.makeCode('\n'), this.makeCode(n)]
                    )
                  }),
                  t
              ...
              (e.Call = o = (function(e) {
                ...
                return (
                  ...
                  (n.prototype.newInstance = function() {
                    ...
                    return (
                      (e =
                        (null != (t = this.variable) ? t.base : void 0) ||
                        this.variable),
                  ...
                  (n.prototype.superReference = function(e) {
                    var n, i
                    return (
                      (i = e.scope.namedMethod()),
                      (null != i
                      ? i.klass
                      : void 0)
                        ? ((n = [new t(new D('__super__'))]),
                          i['static'] && n.push(new t(new D('constructor'))),
                          n.push(new t(new D(i.name))),
                          new Z(new D(i.klass), n).compile(e))
                        : (null != i
                          ? i.ctor
                          : void 0)
                        ? '' + i.name + '.__super__.constructor'
                        : this.error(
                  ...
                  (n.prototype.unfoldSoak = function(e) {
                    ...
                    if (this.soak) {
                      if (this.variable) {
                        if ((i = kt(e, this, 'variable'))) return i
                        ;(h = new Z(this.variable).cacheReference(e)),
                          (r = h[0]),
                          (o = h[1])
                      } else (r = new D(this.superReference(e))), (o = new Z(r))
                      return (
                        (o = new n(o, this.args)),
                        (o.isNew = this.isNew),
                        (r = new D(
                          'typeof ' + r.compile(e) + ' === "function"'
                        )),
                        new v(r, new Z(o), { soak: !0 })
                      )
                    }
                    for (t = this, s = []; ; )
                      if (t.variable instanceof n) s.push(t), (t = t.variable)
                      else {
                        if (!(t.variable instanceof Z)) break
                  ...
                  (n.prototype.compileNode = function(e) {
                    ...
                    if (
                      (null != (h = this.variable) && (h.front = this.front),
                      (r = G.compileSplattedArray(e, this.args, !0)),
                      r.length)
                    )
                      return this.compileSplat(e, r)
                    for (
                      i = [], l = this.args, n = a = 0, c = l.length;
                      c > a;
                      n = ++a
                    )
                      (t = l[n]),
                        n && i.push(this.makeCode(', ')),
                        i.push.apply(i, t.compileToFragments(e, C))
                    return (
                      (s = []),
                      this.isSuper
                        ? ((o =
                          ...
                          i.length && (o += ', '),
                          s.push(this.makeCode(o)))
                        : (this.isNew && s.push(this.makeCode('new ')),
                          s.push.apply(
                            s,
                            this.variable.compileToFragments(e, F)
                          ),
                          s.push(this.makeCode('('))),
                      s.push.apply(s, i),
                      s.push(this.makeCode(')')),
                    ...
                    return this.isSuper
                      ...
                      ? ((s = this.tab + X),
                        [].concat(
                          ...
                          this.variable.compileToFragments(e, C),
                          this.makeCode(', '),
                          t,
                          this.makeCode(', function(){})')
                        ))
                      : ((n = []),
                        ...
                        (o = i.properties.pop()) && i.isComplex()
                          ? ((a = e.scope.freeVariable('ref')),
                            (n = n.concat(
                              this.makeCode('(' + a + ' = '),
                              i.compileToFragments(e, C),
                              this.makeCode(')'),
                              o.compileToFragments(e)
                            )))
                          : ((r = i.compileToFragments(e, F)),
                            P.test(at(r)) && (r = this.wrapInBraces(r)),
                            o
                              ? ((a = at(r)),
                                r.push.apply(r, o.compileToFragments(e)))
                              : (a = 'null'),
                            (n = n.concat(r))),
                        (n = n.concat(
                          this.makeCode('.apply(' + a + ', '),
                          t,
                          this.makeCode(')')
                        )))
                  }),
              ...
              (e.Extends = d = (function(e) {
                ...
                return (
                  ...
                  (t.prototype.compileToFragments = function(e) {
                    return new o(new Z(new D(yt('extends'))), [
                      this.child,
                      this.parent
              ...
              (e.Index = T = (function(e) {
                ...
                return (
                  ...
                  (t.prototype.compileToFragments = function(e) {
                    return [].concat(
                      this.makeCode('['),
                      this.index.compileToFragments(e, E),
                      this.makeCode(']')
                    )
                  }),
                  (t.prototype.isComplex = function() {
              ...
              (e.Range = B = (function(e) {
                ...
                return (
                  ...
                  (t.prototype.compileVariables = function(e) {
                    ...
                    return (
                      (e = pt(e, { top: !0 })),
                      (n = this.cacheToCodeFragments(this.from.cache(e, C))),
                      (this.fromC = n[0]),
                      (this.fromVar = n[1]),
                      (i = this.cacheToCodeFragments(this.to.cache(e, C))),
                      (this.toC = i[0]),
                      (this.toVar = i[1]),
                      (t = it(e, 'step')) &&
                        ((r = this.cacheToCodeFragments(t.cache(e, C))),
                        (this.step = r[0]),
                        (this.stepVar = r[1])),
                      (s = [this.fromVar.match(I), this.toVar.match(I)]),
                      (this.fromNum = s[0]),
                      (this.toNum = s[1]),
                      this.stepVar
                        ? (this.stepNum = this.stepVar.match(I))
                        : void 0
                    )
                  }),
                  (t.prototype.compileNode = function(e) {
                    ...
                    return (
                      ...
                      e.index
                        ? ((a = this.fromNum && this.toNum),
                          (s = it(e, 'index')),
                          (o = it(e, 'name')),
                          (h = o && o !== s),
                          (p = '' + s + ' = ' + this.fromC),
                          this.toC !== this.toVar && (p += ', ' + this.toC),
                          this.step !== this.stepVar && (p += ', ' + this.step),
                          (d = [
                            '' + s + ' <' + this.equals,
                            '' + s + ' >' + this.equals
                          ]),
                          ...
                          (n = this.stepNum
                            ? ft(this.stepNum[0]) > 0
                              ...
                              : '' + r + ' ' + this.toVar
                            : a
                            ? ((f = [ft(this.fromNum[0]), ft(this.toNum[0])]),
                              (i = f[0]),
                              (u = f[1]),
                              f,
                              u >= i ? '' + c + ' ' + u : '' + r + ' ' + u)
                  ...
                  (t.prototype.compileArray = function(e) {
                    ...
                    return this.fromNum &&
                      ...
                      ? ((h = function() {
                          d = []
                          for (
                            var e = (p = +this.fromNum), t = +this.toNum;
                            t >= p ? t >= e : e >= t;
                            t >= p ? e++ : e--
                          )
                            d.push(e)
                        ...
                        [this.makeCode('[' + h.join(', ') + ']')])
                      : ((o = this.tab + X),
                        (s = e.scope.freeVariable('i')),
                        (l = e.scope.freeVariable('results')),
                        (c = '\n' + o + l + ' = [];'),
                        this.fromNum && this.toNum
                          ? ((e.index = s), (n = at(this.compileNode(e))))
                          : ((u =
                              '' +
                              s +
                              ' = ' +
                ...
                return (
                  ...
                  (t.prototype.compileNode = function(e) {
                    ...
                    return (
                      ...
                      (s = a.to),
                      (i = a.from),
                      (r = (i && i.compileToFragments(e, E)) || [
                        this.makeCode('0')
                      ]),
                      s &&
                        ((t = s.compileToFragments(e, E)),
                        (n = at(t)),
                        (this.range.exclusive || -1 !== +n) &&
                          (o =
                            ...
                            (this.range.exclusive
                              ...
                              : P.test(n)
                              ? '' + (+n + 1)
                              : ((t = s.compileToFragments(e, F)),
                                '+' + at(t) + ' + 1 || 9e9')))),
                      [this.makeCode('.slice(' + at(r) + (o || '') + ')')]
                    )
                  }),
                  t
                )
              ...
              (e.Obj = _ = (function(e) {
                ...
                return (
                  Ft(t, e),
                  (t.prototype.children = ['properties']),
                  (t.prototype.compileNode = function(e) {
                    ...
                    for (
                      r = e.indent += X,
                        a = this.lastNonComment(this.properties),
                        t = [],
                        n = d = 0,
                        m = u.length;
                      m > d;
                      ...
                      (h = u[n]),
                        ...
                        (s = h instanceof l ? '' : r),
                        h instanceof i &&
                          h.variable instanceof Z &&
                          h.variable.hasProperties() &&
                          h.variable.error('Invalid object key'),
                        h instanceof Z &&
                          h['this'] &&
                          (h = new i(h.properties[0].name, h, 'object')),
                        h instanceof l ||
                          (h instanceof i || (h = new i(h, h, 'object')),
                          ((h.variable.base || h.variable).asKey = !0)),
                        s && t.push(this.makeCode(s)),
                        t.push.apply(t, h.compileToFragments(e, x)),
                        o && t.push(this.makeCode(o))
                    return (
                      t.unshift(this.makeCode('{' + (u.length && '\n'))),
                      t.push(
                        this.makeCode('' + (u.length && '\n' + this.tab) + '}')
                      ),
                      this.front ? this.wrapInBraces(t) : t
                    )
                  }),
                  (t.prototype.assigns = function(e) {
                    var t, n, i, r
                    for (r = this.properties, n = 0, i = r.length; i > n; n++)
                      if (((t = r[n]), t.assigns(e))) return !0
                    return !1
                  }),
                  t
                )
                    ...
                    for (
                      t = [],
                        n = function() {
                          var t, n, i, r
                          for (
                            i = this.objects, r = [], t = 0, n = i.length;
                            n > t;
                            t++
                          )
                ...
                return (
                  ...
                  (n.prototype.determineName = function() {
                    ...
                    return this.variable
                      ? ((e = (n = lt(this.variable.properties))
                          ? n instanceof t && n.name.value
                  ...
                  (n.prototype.setContext = function(e) {
                    return this.body.traverseChildren(!1, function(t) {
                      return t.classBody
                        ? !1
                        : t instanceof D && 'this' === t.value
                        ? (t.value = e)
                        : t instanceof c && ((t.klass = e), t.bound)
                        ? (t.context = e)
                        : void 0
                    })
                  }),
                  (n.prototype.addBoundFunctions = function(e) {
                    ...
                    for (o = this.boundFuncs, r = 0, s = o.length; s > r; r++)
                      (n = o[r]),
                        (i = new Z(new D('this'), [new t(n)]).compile(e)),
                          ...
                          s instanceof i &&
                            ...
                            'constructor' === o.value
                              ? (this.ctor &&
                                ...
                                h instanceof c
                                  ? (s = this.ctor = h)
                                  : ((this.externalCtor = r.classScope.freeVariable(
                                      'class'
                                    )),
                                    (s = new i(new D(this.externalCtor), h))))
                              : s.variable['this']
                              ? (h['static'] = !0)
                              : ((s.variable = new Z(new D(n), [
                                  new t(new D('prototype')),
                                  new t(o)
                                ])),
                                h instanceof c &&
                                  h.bound &&
                                  (this.boundFuncs.push(o), (h.bound = !1)))),
                            e.push(s)
                        return e
                      }.call(this)),
                      nt(a)
                  ...
                  (n.prototype.walkBody = function(e, t) {
                    return this.traverseChildren(
                      ...
                      (function(r) {
                        return function(o) {
                          var a, c, h, l, u, p, d
                          if (((a = !0), o instanceof n)) return !1
                          if (o instanceof s) {
                            for (
                              d = c = o.expressions, h = u = 0, p = d.length;
                              p > u;
                              h = ++u
                            )
                              (l = d[h]),
                                l instanceof i && l.variable.looksStatic(e)
                                  ? (l.value['static'] = !0)
                                  : l instanceof Z &&
                                    l.isObject(!0) &&
                                    ((a = !1),
                                    (c[h] = r.addProperties(l, e, t)))
                  ...
                  (n.prototype.compileNode = function(e) {
                    ...
                    return (
                      (a = this.body.jumps()) &&
                        a.error('Class bodies cannot contain pure statements'),
                      (n = this.body.contains(ct)) &&
                        n.error("Class bodies shouldn't reference arguments"),
                      ...
                      this.parent &&
                        ((p = new D(e.classScope.freeVariable('super', !1))),
                        this.body.expressions.unshift(new d(l, p)),
                        r.params.push(new O(p)),
                        t.push(this.parent)),
                      (f = this.body.expressions).unshift.apply(
                        f,
                        this.directives
                      ),
                      (h = new j(new o(r, t))),
                      this.variable && (h = new i(this.variable, h)),
                      h.compileToFragments(e)
                    )
                  }),
                  n
                )
              ...
              (e.Assign = i = (function(e) {
                function n(e, t, n, i) {
                  ...
                  ;(this.variable = e),
                    (this.value = t),
                    (this.context = n),
                    (this.param = i && i.param),
                    (this.subpattern = i && i.subpattern),
                ...
                return (
                  ...
                  (n.prototype.isStatement = function(e) {
                    return (
                      (null != e ? e.level : void 0) === x &&
                      null != this.context &&
                      Lt.call(this.context, '?') >= 0
                    )
                  }),
                  ...
                  (n.prototype.compileNode = function(e) {
                    ...
                    return (
                      (n = this.variable.compileToFragments(e, C)),
                      (s = at(n)),
                      this.context ||
                        ((a = this.variable.unwrapAll()),
                        a.isAssignable() ||
                          this.variable.error(
                            '"' +
                        ...
                        ('function' == typeof a.hasProperties
                          ? a.hasProperties()
                          : void 0) ||
                          (this.param
                            ? e.scope.add(s, 'var')
                            : e.scope.find(s))),
                      this.value instanceof c &&
                        (r = S.exec(s)) &&
                        (r[2] && (this.value.klass = r[1]),
                        (this.value.name =
                          null != (u = null != (p = r[3]) ? p : r[4])
                            ? u
                            : r[5])),
                      (o = this.value.compileToFragments(e, C)),
                      'object' === this.context
                        ? n.concat(this.makeCode(': '), o)
                        : ((t = n.concat(
                            this.makeCode(' ' + (this.context || '=') + ' '),
                            o
                          )),
                          C >= e.level ? t : this.wrapInBraces(t))
                    )
                  }),
                  (n.prototype.compilePatternMatch = function(e) {
                        ...
                        f instanceof n
                          ...
                          : (h = l
                              ? f['this']
                                ...
                                : f
                              : new D(0)),
                        (i = b.test(h.unwrap().value || 0)),
                        (F = new Z(F)),
                        F.properties.push(new (i ? t : T)(h)),
                        (_ = f.unwrap().value),
                        Lt.call(M, _) >= 0 &&
                          f.error(
                            'assignment to a reserved word: ' + f.compile(e)
                          ),
                        new n(f, F, null, {
                          param: this.param
                    ...
                    for (
                      L = F.compileToFragments(e, C),
                        E = at(L),
                        r = [],
                        o = !1,
                        (!b.test(E) || this.variable.assigns(E)) &&
                          (r.push(
                            [
                              this.makeCode(
                                '' + (k = e.scope.freeVariable('ref')) + ' = '
                              )
                            ].concat(Ct.call(L))
                          ),
                          (L = [this.makeCode(k)]),
                        ...
                        l &&
                          (f instanceof n
                            ? (($ = f),
                              ...
                              (f = $.value))
                            : f.base instanceof j
                            ? ((B = new Z(f.unwrapAll()).cacheReference(e)),
                              (f = B[0]),
                              (h = B[1]))
                            : (h = f['this'] ? f.properties[0].name : f)),
                        !o && f instanceof G)
                      )
                        (d = f.name.unwrap().value),
                          (f = f.unwrap()),
                          (w =
                            '' +
                            g +
                          ...
                          ;(y = g - c - 1) &&
                            (1 === y
                              ...
                              : ((u = e.scope.freeVariable('i')),
                                ...
                                (o = '' + u + '++'),
                                r.push(w.compileToFragments(e, C))))
                          continue
                        }
                        ;(d = f.unwrap().value),
                          (f instanceof G || f instanceof p) &&
                            f.error(
                              'multiple splats/expansions are disallowed in an assignment'
                            ),
                          'number' == typeof h
                            ? ((h = new D(o || h)), (i = !1))
                            : (i = l && b.test(h.unwrap().value || 0)),
                          (w = new Z(new D(E), [new (i ? t : T)(h)]))
                      }
                      null != d &&
                        Lt.call(M, d) >= 0 &&
                        f.error(
                        ...
                        r.push(
                          new n(f, w, null, {
                            param: this.param,
                            subpattern: !0
                          }).compileToFragments(e, C)
                        )
                    }
                    return (
                      v || this.subpattern || r.push(L),
                      (a = this.joinFragmentArrays(r, ', ')),
                      C > e.level ? a : this.wrapInBraces(a)
                    )
                  }),
                  (n.prototype.compileConditional = function(e) {
                    var t, i, r, s
                    return (
                      (s = this.variable.cacheReference(e)),
                      (i = s[0]),
                      (r = s[1]),
                      !i.properties.length &&
                        i.base instanceof D &&
                        'this' !== i.base.value &&
                        !e.scope.check(i.base.value) &&
                        this.variable.error(
                          'the variable "' +
                            i.base.value +
                      ...
                      Lt.call(this.context, '?') >= 0
                        ? ((e.isExistentialEquals = !0),
                          new v(new u(i), r, { type: 'if' })
                            .addElse(new n(r, this.value, '='))
                            .compileToFragments(e))
                        : ((t = new $(
                  ...
                  (n.prototype.compileSpecialMath = function(e) {
                    ...
                    return (
                      ...
                      new n(
                        t,
                        new $(this.context.slice(0, -1), i, this.value)
                      ).compileToFragments(e)
                    )
                  }),
                  (n.prototype.compileSplice = function(e) {
                    ...
                    return (
                      (l = this.variable.properties.pop().range),
                      (i = l.from),
                      (a = l.to),
                      (n = l.exclusive),
                      (o = this.variable.compile(e)),
                      i
                        ? ((u = this.cacheToCodeFragments(i.cache(e, N))),
                          (r = u[0]),
                          (s = u[1]))
                        : (r = s = '0'),
                      a
                        ? i instanceof Z &&
                          ...
                          a instanceof Z &&
                          a.isSimpleNumber()
                          ? ((a = a.compile(e) - s), n || (a += 1))
                          : ((a = a.compile(e, F) + ' - ' + s),
                            n || (a += ' + 1'))
                        : (a = '9e9'),
                      (p = this.value.cache(e, C)),
                      (c = p[0]),
                      (h = p[1]),
                      (t = [].concat(
                        this.makeCode(
                      ...
                      e.level > x ? this.wrapInBraces(t) : t
                    )
                  }),
                  n
                )
              ...
              (e.Code = c = (function(e) {
                ...
                return (
                  ...
                  (t.prototype.compileNode = function(e) {
                    ...
                    if (
                      (this.bound &&
                        (null != (B = e.scope.method) ? B.bound : void 0) &&
                      ...
                      return (
                        (this.context = '_this'),
                        (T = new t(
                          [new O(new D(this.context))],
                          new s([this])
                        )),
                        (a = new o(T, [new D('this')])),
                        a.updateLocationDataIfMissing(this.locationData),
                        a.compileNode(e)
                      )
                    for (
                      e.scope = it(e, 'classScope') || this.makeScope(e.scope),
                        e.scope.shared = it(e, 'sharedScope'),
                        e.indent += X,
                        delete e.bare,
                      ...
                      (f = V[L]),
                        f instanceof p || e.scope.parameter(f.asReference(e))
                    for (P = this.params, C = 0, S = P.length; S > C; C++)
                      if (((f = P[C]), f.splat || f instanceof p)) {
                        for (U = this.params, N = 0, R = U.length; R > N; N++)
                          (d = U[N].name),
                            f instanceof p ||
                              (d['this'] && (d = d.properties[0].name),
                              d.value && e.scope.add(d.value, 'var', !0))
                        g = new i(
                          new Z(
                            new n(
                              function() {
                                var t, n, i, r
                                for (
                                  i = this.params, r = [], t = 0, n = i.length;
                                  n > t;
                                  t++
                                )
                    ...
                    for (H = this.params, E = 0, A = H.length; A > E; E++)
                      (f = H[E]),
                        f.isComplex()
                          ? ((y = b = f.asReference(e)),
                            f.value && (y = new $('?', b, f.value)),
                            h.push(new i(new Z(f.name), y, '=', { param: !0 })))
                          : ((b = f),
                            f.value &&
                              ((u = new D(b.name.value + ' == null')),
                              (y = new i(new Z(f.name), f.value, '=')),
                              h.push(new v(u, y)))),
                        g || m.push(b)
                    for (
                      w = this.body.isEmpty(),
                        g && h.unshift(g),
                        h.length &&
                          (q = this.body.expressions).unshift.apply(q, h),
                        l = j = 0,
                        I = m.length;
                      I > j;
                      l = ++j
                      ...
                      (d = m[l]),
                        (m[l] = d.compileToFragments(e)),
                        e.scope.parameter(at(m[l]))
                    for (
                      k = [],
                        this.eachParamName(function(e, t) {
                          return (
                            Lt.call(k, e) >= 0 &&
                              t.error("multiple parameters named '" + e + "'"),
                            k.push(e)
                          )
                        }),
                        w || this.noReturn || this.body.makeReturn(),
                        c = 'function',
                    ...
                    return (
                      ...
                      r.push(this.makeCode('}')),
                      this.ctor
                        ? [this.makeCode(this.tab)].concat(Ct.call(r))
                        : this.front || e.level >= F
                        ? this.wrapInBraces(r)
                        : r
                    )
                  }),
                  (t.prototype.eachParamName = function(e) {
                    var t, n, i, r, s
                    for (
                      r = this.params, s = [], n = 0, i = r.length;
                      i > n;
                      n++
                    )
              ...
              (e.Param = O = (function(e) {
                function t(e, t, n) {
                  var i
                  ;(this.name = e),
                    (this.value = t),
                    (this.splat = n),
                    (i = e = this.name.unwrapAll().value),
                    Lt.call(U, i) >= 0 &&
                      this.name.error(
                        'parameter name "' + e + '" is not allowed'
                      )
                }
                return (
                  Ft(t, e),
                  ...
                  (t.prototype.asReference = function(e) {
                    ...
                    return this.reference
                      ...
                      : ((t = this.name),
                        t['this']
                          ? ((t = t.properties[0].name),
                            t.value.reserved &&
                              (t = new D(e.scope.freeVariable(t.value))))
                          : t.isComplex() &&
                            (t = new D(e.scope.freeVariable('arg'))),
                        (t = new Z(t)),
                        this.splat && (t = new G(t)),
                        t.updateLocationDataIfMissing(this.locationData),
                        (this.reference = t))
                  }),
                  (t.prototype.isComplex = function() {
                  ...
                  (t.prototype.eachName = function(e, t) {
                    ...
                    if (
                      ...
                      (n = function(t) {
                        var n
                        return (
                          (n = t.properties[0].name),
                          n.value.reserved ? void 0 : e(n.value, n)
                        )
                      }),
                      t instanceof D)
                    )
                      return e(t.value, t)
                    if (t instanceof Z) return n(t)
                    for (c = t.objects, o = 0, a = c.length; a > o; o++)
                      (s = c[o]),
                        s instanceof i
                          ? this.eachName(e, s.value.unwrap())
                          : s instanceof G
                          ? ((r = s.name.unwrap()), e(r.value, r))
                          : s instanceof Z
                          ? s.isArray() || s.isObject()
                            ? this.eachName(e, s.base)
                            : s['this']
                            ? n(s)
                            : e(s.base.value, s.base)
                          : s instanceof p ||
                            s.error('illegal parameter ' + s.compile())
                  }),
                  t
                )
              })(r)),
                ...
                return (
                  ...
                  (t.compileSplattedArray = function(e, n, i) {
                    ...
                    if (1 === n.length)
                      return (
                        (u = n[0]),
                        (c = u.compileToFragments(e, C)),
                        i
                          ? c
                          : [].concat(
                              u.makeCode('' + yt('slice') + '.call('),
                              c,
                              u.makeCode(')')
                            )
                      )
                    for (
                      r = n.slice(l), h = p = 0, d = r.length;
                      d > p;
                      h = ++p
                    )
                      (u = r[h]),
                        (o = u.compileToFragments(e, C)),
                        (r[h] =
                          u instanceof t
                            ? [].concat(
                                u.makeCode('' + yt('slice') + '.call('),
                            ...
                            : [].concat(u.makeCode('['), o, u.makeCode(']')))
                    return 0 === l
                      ? ((u = n[0]),
                        (a = u.joinFragmentArrays(r.slice(1), ', ')),
                        r[0].concat(u.makeCode('.concat('), a, u.makeCode(')')))
                      : ((s = (function() {
                          var t, i, r, s
                          for (
                            r = n.slice(0, l), s = [], t = 0, i = r.length;
                            i > t;
                            t++
                          )
              ...
              (e.While = Q = (function(e) {
                function t(e, t) {
                  ;(this.condition = (null != t
                  ? t.invert
                  : void 0)
                    ? e.invert()
                    : e),
                ...
                return (
                  ...
                  (t.prototype.jumps = function() {
                    ...
                    for (i = 0, r = e.length; r > i; i++)
                      if (((n = e[i]), (t = n.jumps({ loop: !0 })))) return t
                    return !1
                  }),
                  (t.prototype.compileNode = function(e) {
                    var t, n, i, r
                    return (
                      ...
                      n.isEmpty()
                        ...
                        : (this.returns &&
                            (n.makeReturn(
                              (i = e.scope.freeVariable('results'))
                            ),
                            (r = '' + this.tab + i + ' = [];\n')),
                          this.guard &&
                            (n.expressions.length > 1
                              ...
                              : this.guard &&
                                (n = s.wrap([new v(this.guard, n)]))),
                          (n = [].concat(
                            this.makeCode('\n'),
                            n.compileToFragments(e, x),
                            this.makeCode('\n' + this.tab)
                          ))),
                      (t = [].concat(
                        this.makeCode(r + this.tab + 'while ('),
                        this.condition.compileToFragments(e, E),
                        this.makeCode(') {'),
                        n,
                        this.makeCode('}')
                      )),
                ...
                return (
                  ...
                  (n.prototype.invert = function() {
                    ...
                    return (r = s[this.operator])
                      ...
                      ? new j(this).invert()
                      : '!' === this.operator &&
                        (i = this.first.unwrap()) instanceof n &&
                        ('!' === (o = i.operator) ||
                          'in' === o ||
                          'instanceof' === o)
                      ? i
                  ...
                  (n.prototype.generateDo = function(e) {
                    ...
                    for (
                      s = [],
                        n =
                          e instanceof i && (a = e.value.unwrap()) instanceof c
                            ? a
                            : e,
                        u = n.params || [],
                        h = 0,
                      ...
                      (r = u[h]),
                        r.value ? (s.push(r.value), delete r.value) : s.push(r)
                  ...
                  (n.prototype.compileNode = function(e) {
                    ...
                    switch (this.operator) {
                      ...
                      default:
                        return (
                          (i = this.first.compileToFragments(e, N)),
                          (r = this.second.compileToFragments(e, N)),
                          (t = [].concat(
                            i,
                  ...
                  (n.prototype.compileExistence = function(e) {
                    ...
                    return (
                      this.first.isComplex()
                        ? ((n = new D(e.scope.freeVariable('ref'))),
                          (t = new j(new i(n, this.first))))
                        : ((t = this.first), (n = t)),
                      new v(new u(t), n, { type: 'if' })
                        .addElse(this.second)
                        .compileToFragments(e)
                    )
                  }),
                  (n.prototype.compileUnary = function(e) {
                    ...
                    return (
                      ...
                      '!' === t && this.first instanceof u
                        ? ((this.first.negated = !this.first.negated),
                          this.first.compileToFragments(e))
                        : e.level >= F
                        ? new j(this).compileToFragments(e)
                        : ((r = '+' === t || '-' === t),
                          ('new' === t ||
                            'typeof' === t ||
                            'delete' === t ||
                          ...
                          ((r && this.first instanceof n) ||
                            ('new' === t && this.first.isStatement(e))) &&
                            (this.first = new j(this.first)),
                          i.push(this.first.compileToFragments(e, N)),
                          this.flip && i.reverse(),
                          this.joinFragmentArrays(i, ''))
                    )
                  }),
                  (n.prototype.compilePower = function(e) {
                    var n
                    return (
                      (n = new Z(new D('Math'), [new t(new D('pow'))])),
                  ...
                  (n.prototype.compileFloorDivision = function(e) {
                    var i, r
                    return (
                      (r = new Z(new D('Math'), [new t(new D('floor'))])),
              ...
              (e.In = w = (function(e) {
                ...
                return (
                  ...
                  (t.prototype.invert = R),
                  (t.prototype.compileNode = function(e) {
                    var t, n, i, r, s
                    if (
                      this.array instanceof Z &&
                      this.array.isArray() &&
                      this.array.base.objects.length
                    ) {
                      for (
                        s = this.array.base.objects, i = 0, r = s.length;
                        r > i;
                        i++
                      )
                  ...
                  (t.prototype.compileOrTest = function(e) {
                    ...
                    for (
                      ...
                      (r = p[i]),
                        i && a.push(this.makeCode(n)),
                        (a = a.concat(
                          i ? s : o,
                          this.makeCode(t),
                          r.compileToFragments(e, F)
                        ))
                  ...
                  (t.prototype.compileLoopTest = function(e) {
                    var t, n, i, r
                    return (
                      (r = this.object.cache(e, C)),
                      (i = r[0]),
                      (n = r[1]),
                      (t = [].concat(
                        this.makeCode(yt('indexOf') + '.call('),
                        this.array.compileToFragments(e, C),
                        this.makeCode(', '),
                        n,
                ...
                return (
                  ...
                  (t.prototype.jumps = function(e) {
                    ...
                    return (
                      ...
                      (null != (t = this.recovery) ? t.jumps(e) : void 0)
                    )
                  }),
                  (t.prototype.makeReturn = function(e) {
                    return (
                  ...
                  (t.prototype.compileNode = function(e) {
                    ...
                    return (
                      (e.indent += X),
                      (s = this.attempt.compileToFragments(e, x)),
                      (t = this.recovery
                        ? ((r = new D('_error')),
                          this.errorVariable
                            ? this.recovery.unshift(
                                new i(this.errorVariable, r)
                              )
                            : void 0,
                          [].concat(
                            this.makeCode(' catch ('),
                            r.compileToFragments(e),
                            this.makeCode(') {\n'),
                            this.recovery.compileToFragments(e, x),
                            this.makeCode('\n' + this.tab + '}')
                          ))
                      ...
                      (n = this.ensure
                        ? [].concat(
                            ...
                            this.ensure.compileToFragments(e, x),
                            this.makeCode('\n' + this.tab + '}')
                          )
                        : []),
                      [].concat(
                ...
                return (
                  ...
                  (t.prototype.compileNode = function(e) {
                    ...
                    return (
                      ...
                      (i = this.expression.compile(e, N)),
                      b.test(i) && !e.scope.check(i)
                        ? ((r = this.negated ? ['===', '||'] : ['!==', '&&']),
                          (t = r[0]),
                          (n = r[1]),
                          (i =
                        ...
                        : (i =
                            ...
                            (this.negated ? '==' : '!=') +
                            ' null'),
                      [this.makeCode(L >= e.level ? i : '(' + i + ')')]
                    )
                  }),
                  t
                )
              })(r)),
              (e.Parens = j = (function(e) {
                function t(e) {
                  this.body = e
                }
                return (
                  ...
                  (t.prototype.compileNode = function(e) {
                    ...
                    return (
                      (n = this.body.unwrap()),
                      n instanceof Z && n.isAtomic()
                        ? ((n.front = this.front), n.compileToFragments(e))
                        : ((i = n.compileToFragments(e, E)),
                          (t =
                            N > e.level &&
                            (n instanceof $ ||
                              n instanceof o ||
                              (n instanceof f && n.returns))),
                ...
                function t(e, t) {
                  ...
                  ;(this.source = t.source),
                    ...
                    this.object &&
                      ...
                      (this.name = n[0]),
                      (this.index = n[1])),
                    this.index instanceof Z &&
                      this.index.error(
                        'index cannot be a pattern matching expression'
                      ),
                    (this.range =
                      this.source instanceof Z &&
                      this.source.base instanceof B &&
                ...
                return (
                  ...
                  (t.prototype.compileNode = function(e) {
                    ...
                    return (
                      (t = s.wrap([this.body])),
                      (T =
                        null != (H = lt(t.expressions)) ? H.jumps() : void 0),
                      T && T instanceof V && (this.returns = !1),
                      ($ = this.range ? this.source.base : this.source),
                      (_ = e.scope),
                      this.pattern ||
                        (L = this.name && this.name.compile(e, C)),
                      (g = this.index && this.index.compile(e, C)),
                      L && !this.pattern && _.find(L),
                      g && _.find(g),
                      this.returns && (A = _.freeVariable('results')),
                      (k = (this.object && g) || _.freeVariable('i')),
                      (y = (this.range && L) || g || k),
                      (w = y !== k ? '' + y + ' = ' : ''),
                      this.step &&
                        !this.range &&
                        ((q = this.cacheToCodeFragments(this.step.cache(e, C))),
                        (O = q[0]),
                        (B = q[1]),
                        (M = B.match(I))),
                      this.pattern && (L = k),
                      ...
                      (f = this.tab + X),
                      this.range
                        ? (p = $.compileToFragments(
                            pt(e, { index: k, name: L, step: this.step })
                          ))
                        : ((P = this.source.compile(e, C)),
                          (!L && !this.own) ||
                            b.test(P) ||
                            ((h +=
                              '' +
                          ...
                          this.object ||
                            (O !== B && (h += '' + this.tab + O + ';\n'),
                            (this.step && M && (u = 0 > ft(M[0]))) ||
                              (F = _.freeVariable('len')),
                            (a =
                              '' +
                              w +
                              k +
                      ...
                      this.guard &&
                        (t.expressions.length > 1
                          ...
                          : this.guard && (t = s.wrap([new v(this.guard, t)]))),
                      this.pattern &&
                        t.expressions.unshift(
                          new i(this.name, new D('' + P + '[' + y + ']'))
                        ),
                      (l = [].concat(
                        this.makeCode(h),
                      ...
                      this.object &&
                        ...
                        this.own &&
                          (d =
                            ...
                            y +
                            ')) continue;')),
                      (n = t.compileToFragments(pt(e, { indent: f }), x)),
                      n &&
                        n.length > 0 &&
                        (n = [].concat(
                          this.makeCode('\n'),
                      ...
                      [].concat(
                        l,
                        this.makeCode('' + (S || '') + this.tab + 'for ('),
                        p,
                        this.makeCode(') {' + d + U),
                        n,
                        this.makeCode('' + this.tab + '}' + (R || ''))
                      )
                    )
                  }),
                  (t.prototype.pluckDirectCall = function(e, t) {
                    ...
                    for (
                      r = [], f = t.expressions, h = p = 0, d = f.length;
                      d > p;
                      h = ++p
                    )
                      (s = f[h]),
                        ...
                        s instanceof o &&
                          ((u =
                            null != (m = s.variable) ? m.unwrapAll() : void 0),
                          (u instanceof c ||
                            (u instanceof Z &&
                              (null != (b = u.base)
                                ? b.unwrapAll()
                                : void 0) instanceof c &&
                              1 === u.properties.length &&
                              ('call' ===
                                (g =
                                  null != (k = u.properties[0].name)
                                    ? k.value
                                    : void 0) ||
                                'apply' === g))) &&
                            ((a =
                              (null != (y = u.base) ? y.unwrapAll() : void 0) ||
                              u),
                            (l = new D(e.scope.freeVariable('fn'))),
                            (n = new Z(l)),
                            u.base &&
                              ((v = [n, u]), (u.base = v[0]), (n = v[1])),
                            (t.expressions[h] = new o(n, s.args)),
                            (r = r.concat(
                              this.makeCode(this.tab),
                              new i(l, a).compileToFragments(e, x),
                              this.makeCode(';\n')
                            ))))
                    return r
                  }),
                ...
                return (
                  ...
                  (t.prototype.makeReturn = function(e) {
                    ...
                    return (
                      e &&
                        (this.otherwise ||
                          (this.otherwise = new s([new D('void 0')]))),
                  ...
                  (t.prototype.compileNode = function(e) {
                    ...
                    for (
                      c = e.indent + X,
                        ...
                        o = [].concat(
                          ...
                          this.subject
                            ? this.subject.compileToFragments(e, E)
                            : this.makeCode('false'),
                          this.makeCode(') {\n')
                        ),
                        f = this.cases,
                      ...
                      for (
                        ...
                        (i = b[u]),
                          ...
                          (o = o.concat(
                            this.makeCode(c + 'case '),
                            i.compileToFragments(e, E),
                            this.makeCode(':\n')
                          ))
                      if (
                        ((n = t.compileToFragments(e, x)).length > 0 &&
                          (o = o.concat(n, this.makeCode('\n'))),
                    ...
                    return (
                      this.otherwise &&
                        ...
                        o.push.apply(
                          o,
                          [this.makeCode(c + 'default:\n')].concat(
                            Ct.call(this.otherwise.compileToFragments(e, x)),
                            [this.makeCode('\n')]
                          )
                        ),
              ...
              (e.If = v = (function(e) {
                ...
                return (
                  ...
                  (t.prototype.jumps = function(e) {
                    ...
                    return (
                      this.body.jumps(e) ||
                      (null != (t = this.elseBody) ? t.jumps(e) : void 0)
                    )
                  }),
                  (t.prototype.compileNode = function(e) {
                  ...
                  (t.prototype.makeReturn = function(e) {
                    return (
                      e &&
                        (this.elseBody ||
                          (this.elseBody = new s([new D('void 0')]))),
                      this.body &&
                        (this.body = new s([this.body.makeReturn(e)])),
                      this.elseBody &&
                        (this.elseBody = new s([this.elseBody.makeReturn(e)])),
                      this
                    )
                  }),
                  ...
                  (t.prototype.compileStatement = function(e) {
                    ...
                    return (
                      (r = it(e, 'chainChild')),
                      (o = it(e, 'isExistentialEquals'))
                        ? new t(this.condition.invert(), this.elseBodyNode(), {
                            type: 'if'
                          }).compileToFragments(e)
                        : ((c = e.indent + X),
                          (s = this.condition.compileToFragments(e, E)),
                          (i = this.ensureBlock(this.body).compileToFragments(
                            pt(e, { indent: c })
                          )),
                          (a = [].concat(
                            this.makeCode('if ('),
                  ...
                  (t.prototype.compileExpression = function(e) {
                    var t, n, i, r
                    return (
                      (i = this.condition.compileToFragments(e, L)),
                      (n = this.bodyNode().compileToFragments(e, C)),
                      (t = this.elseBodyNode()
                        ? this.elseBodyNode().compileToFragments(e, C)
                        : [this.makeCode('void 0')]),
                      (r = i.concat(
                        this.makeCode(' ? '),
                        n,
                      ...
                      e.level >= L ? this.wrapInBraces(r) : r
                    )
                  }),
              ...
              (ht = function(e) {
                return (
                  (e instanceof D && 'this' === e.value && !e.asKey) ||
                  (e instanceof c && e.bound) ||
          ...
          function() {
            ...
            ;(e = (function() {
              ...
              (n = (function() {
                ...
                var n, i, r, s
                return (
                  (t.prototype.add = function(t, n, i) {
                    var r, s, o, a
                    return (
                      null == i && (i = {}),
                      (s = n[0]),
                      (r = n[1]),
                      (o = (a = this.lines)[s] || (a[s] = new e(s))),
                      o.add(r, t, i)
                    )
                  }),
                        ...
                        for (g = o.columns, d = 0, m = g.length; m > d; d++)
                          if ((c = g[d])) {
                            for (; c.line > u; )
                              (i = 0), (h = !1), (n += ';'), u++
                            h && ((n += ','), (h = !1)),
                              (n += this.encodeVlq(c.column - i)),
                              (i = c.column),
                              (n += this.encodeVlq(0)),
                              (n += this.encodeVlq(c.sourceLine - s)),
                              (s = c.sourceLine),
                              (n += this.encodeVlq(c.sourceColumn - r)),
                              (r = c.sourceColumn),
                              (h = !0)
                          }
                    return (
        ...
        return (
          function() {
            ...
            if (
              ...
              (f = function(e) {
                return function(t, n) {
                  ...
                  try {
                    ...
                    throw ((i = r), c.updateSyntaxError(i, t, n.filename))
                  }
                }
              }),
              (e.compile = i = f(function(e, t) {
                var i, r, s, o, a, u, p, d, f, m, b, g, k
                for (
                  m = c.merge,
                    o = c.extend,
                    t = o({}, t),
                    t.sourceMap && (f = new n()),
                    u = l.parse(h.tokenize(e, t)).compileToFragments(t),
                    s = 0,
                    t.header && (s += 1),
                    t.shiftLine && (s += 1),
                    r = 0,
                  ...
                  (a = u[g]),
                    t.sourceMap &&
                      ...
                      (s += b),
                      b
                        ? (r = a.code.length - (a.code.lastIndexOf('\n') + 1))
                        : (r += a.code.length)),
                    (d += a.code)
                return (
                  t.header &&
                    ((p = 'Generated by CoffeeScript ' + this.VERSION),
                    (d = '// ' + p + '\n' + d)),
                  t.sourceMap
                    ? ((i = { js: d }),
                      (i.sourceMap = f),
                      (i.v3SourceMap = f.generate(t, e)),
                      i)
                    : d
                )
              })),
              (e.tokens = f(function(e, t) {
                return h.tokenize(e, t)
              })),
              (e.nodes = f(function(e, t) {
                return 'string' == typeof e
                  ? l.parse(h.tokenize(e, t))
                  : l.parse(e)
              })),
              (e.run = function(e, t) {
                var n, r, s, a
                return (
                  null == t && (t = {}),
                  (s = require.main),
                  (s.filename = process.argv[1] = t.filename
                    ? o.realpathSync(t.filename)
                    : '.'),
                  s.moduleCache && (s.moduleCache = {}),
                  (r = t.filename
                    ? u.dirname(o.realpathSync(t.filename))
                    : o.realpathSync('.')),
                  (s.paths = require('module')._nodeModulePaths(r)),
                  (!c.isCoffee(s.filename) || require.extensions) &&
                    ((n = i(e, t)), (e = null != (a = n.js) ? a : n)),
                  s._compile(e, s.filename)
                )
              }),
              (e.eval = function(e, t) {
                var n, r, s, o, a, c, h, l, p, f, m, b, g, k
                  ...
                  if ((r = d.Script)) {
                    if (null != t.sandbox) {
                      if (t.sandbox instanceof r.createContext().constructor)
                        ...
                        ;(h = r.createContext()), (b = t.sandbox)
                        for (o in b) y.call(b, o) && ((l = b[o]), (h[o] = l))
                      }
                      h.global = h.root = h.GLOBAL = h
                    } else h = global
                    if (
                      ((h.__filename = t.filename || 'eval'),
                      (h.__dirname = u.dirname(h.__filename)),
                      h === global && !h.module && !h.require)
                    ) {
                      for (
                        n = require('module'),
                          h.module = m = new n(t.modulename || 'eval'),
                          h.require = k = function(e) {
                            return n._load(e, m, !0)
                          },
                          m.filename = h.__filename,
                          g = Object.getOwnPropertyNames(require),
                          p = 0,
                          f = g.length;
                        f > p;
                        p++
                      )
                        (c = g[p]), 'paths' !== c && (k[c] = require[c])
                      ;(k.paths = m.paths = n._nodeModulePaths(process.cwd())),
                        (k.resolve = function(e) {
                          return n._resolveFilename(e, m)
                        })
                    }
                  }
                  a = {}
                  for (o in t) y.call(t, o) && ((l = t[o]), (a[o] = l))
                  return (
                    (a.bare = !0),
                    (s = i(e, a)),
                    h === global ? d.runInThisContext(s) : d.runInContext(s, h)
                  )
                }
              }),
              (e.register = function() {
              ...
              for (k = this.FILE_EXTENSIONS, b = 0, g = k.length; g > b; b++)
                (r = k[b]),
                  null == (m = require.extensions)[r] &&
                    (m[r] = function() {
                      throw Error(
            ...
            ;(e._compileFile = function(e, t) {
              var n, r, s, a
              null == t && (t = !1),
                (s = o.readFileSync(e, 'utf8')),
                (a = 65279 === s.charCodeAt(0) ? s.substring(1) : s)
              try {
                n = i(a, {
                  filename: e,
                  sourceMap: t,
                ...
                throw ((r = h), c.updateSyntaxError(r, a, e))
              }
              return n
            }),
              (h = new t()),
                ...
                return (
                  ...
                  (r =
                    s === a[a.length - 1]
                      ...
                      : 'INDENT' === i || 'OUTDENT' === i
                      ? 'indentation'
                      : c.nameWhitespaceCharacter(r)),
                  c.throwSyntaxError('unexpected ' + r, n)
                )
              }),
              (s = function(e, t) {
              ...
              (a = function(t) {
                ...
                if (p[t]) return p[t]
                if (
                  ((i = null != u ? u.extname(t) : void 0),
                  !(0 > v.call(e.FILE_EXTENSIONS, i)))
                )
                  return (n = e._compileFile(t, !0)), (p[t] = n.sourceMap)
              }),
            ...
            ;(CoffeeScript = require('./coffee-script')),
              ...
              'undefined' != typeof window &&
                ...
                window.addEventListener
                  ? window.addEventListener('DOMContentLoaded', runScripts, !1)
